          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-extrabold text-slate-800 dark:text-white">AI Invoice Maker</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="space-y-4">
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-700 shadow-sm space-y-4">
                  ...
                  <div>
                    ...
                    <textarea value={form.billTo} onChange={(e) => setForm({ ...form, billTo: e.target.value })} rows={3}
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-700 shadow-sm">
                  ...
                  <div className="grid grid-cols-12 gap-1 mb-2 px-1">
                    ...
                    <span className="col-span-3 text-xs text-slate-400">Rate (₹)</span>
                    <span className="col-span-1 text-xs text-slate-400 text-right">Amt</span>
                  </div>
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold">CA</div>
                </div>
                ...
                <div className="space-y-1 text-xs mb-6">
                  ...
                  <div className="flex justify-between text-slate-500"><span>GST (18%)</span><span>{fmt(gst)}</span></div>
                ...
                <button onClick={handleDownload}
                  className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm py-3 rounded-xl transition-colors shadow-md shadow-emerald-200 dark:shadow-emerald-900/30">
